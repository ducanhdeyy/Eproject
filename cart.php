            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <a href="?action=change-quantity&id=<?php echo  $cartItem['product']->id; ?>&step=-1" class="cursor-pointer w-5 h-5  justify-center items-center inline-block bg-black text-white rounded">
                        <span>-</span>
                      </a>    
                    ...
                    <td>
                    <a href="?action=remove&id=<?php echo  $cartItem['product']->id; ?>&step=1" class="cursor-pointer w-16 h-5  justify-center items-center inline-block bg-black text-white rounded">
                        Remove
                      </a>
                    </td>
                </tr>
